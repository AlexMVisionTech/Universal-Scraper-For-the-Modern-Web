...
if TYPE_CHECKING:
    ...
    from scrapling.fetchers import Fetcher, AsyncFetcher, StealthyFetcher, DynamicFetcher, SearchFetcher
...
_LAZY_IMPORTS = {
    ...
    "SearchFetcher": ("scrapling.fetchers", "SearchFetcher"),
}
__all__ = ["Selector", "Fetcher", "AsyncFetcher", "StealthyFetcher", "DynamicFetcher", "SearchFetcher"]
